...
def append_to_csv(dataList):
  ...
  with open("D:\Workstation\python\Distillery\scrape-distillery\whiskey-map.com\WhiskeyMaps - Attributes.csv", "r") as f:
    reader = csv.reader(f)
    ...
    # Append row to CSV
    try:
        with open("D:\Workstation\python\Distillery\scrape-distillery\whiskey-map.com\WhiskeyMaps - Attributes.csv", "a", newline='') as f:
